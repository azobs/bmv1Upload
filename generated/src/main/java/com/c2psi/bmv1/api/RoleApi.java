...
public interface RoleApi {
    ...
    /**
     * DELETE /role/delete/{id} : Path used to delete a role in the system with its id
     *
    ...
    /**
     * GET /role/getby/{id} : Find a Role in the system by its id
     *
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"roleName\" : \"roleName\", \"id\" : 0, \"roleType\" : \"ADMINBM\", \"roleDescription\" : \"roleDescription\" }";
    ...
    /**
     * POST /role/list : Path used to list role that respect certain criteria. A criteria is an instance of a Filter object
     *
    ...
    /**
     * POST /role/page : Path used to list roles page by page that respect certain criteria. With the Page object, we can configure the page number and size that we want
     *
     * @param filterRequest  (optional)
    ...
    default  ResponseEntity<PageofRoleDto> getRolePage(FilterRequest filterRequest) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"totalPages\" : 6, \"pageSize\" : 5, \"currentPage\" : 1, \"content\" : [ { \"roleName\" : \"roleName\", \"id\" : 0, \"roleType\" : \"ADMINBM\", \"roleDescription\" : \"roleDescription\" }, { \"roleName\" : \"roleName\", \"id\" : 0, \"roleType\" : \"ADMINBM\", \"roleDescription\" : \"roleDescription\" } ], \"totalElements\" : 0 }";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
            }
    ...
    /**
     * POST /role/create : Path used to save a new role in the system
     *
    ...
    /**
     * PUT /role/update : Path used to update or modify an existing role in the system
     *
     * @param roleDto  (optional)
